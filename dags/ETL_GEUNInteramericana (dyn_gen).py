...
def extract_csv():
    ...
    if "Interamericana" == "Interamericana":
...
# se define el DAG
with DAG(
    dag_id = "ETL_GEUNInteramericana_dyn", 
    start_date=datetime(2022, 11, 4), 
...
# se definen los tasks
    ...
    tarea_3 = LocalFilesystemToS3Operator(
        ...
        filename= os.path.join(os.getcwd, 'GE_'+ 'Interamericana'+'.txt'),
        dest_key='GEUN'+'Interamericana'+'_process.txt',
        dest_bucket='dipa-s3',
