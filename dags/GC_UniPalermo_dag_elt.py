...
with DAG(
    ...
    description='Extrraccion, tranformacion y carga a s3 de datos de la Universidad De Palermo.',
    ...
    load_task = LocalFilesystemToS3Operator(
        ...
        filename='/usr/local/airflow/datasets/GC_UniPalermo_process.txt',
        dest_key='GC_UniPalermo_process.txt',
        dest_bucket='dipa-s3',
